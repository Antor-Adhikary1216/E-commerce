        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 px-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="login-prompt-title">
          ...
          >
            ...
            <div className="mt-5 space-y-2">
              <Link href="/login" className="flex h-11 w-full items-center justify-center gap-2.5 rounded-full border border-slate-200 px-5 text-[13px] font-semibold transition hover:bg-slate-50">
              ...
              <Link href="/login" className="block w-full rounded-full bg-[#16815d] px-5 py-2.5 text-center text-[13px] font-semibold text-white transition hover:bg-[#147a56]">
                Log in with email
              </Link>
            </div>
